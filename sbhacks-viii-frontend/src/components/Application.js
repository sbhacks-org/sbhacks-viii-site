        ...
        <div className={classes.formContainer}>
          ...
          <form onSubmit={saveApp}>
            ...
            <textarea
              id="frq1"
              rows="8"
              placeholder="This is the answer to a free response question"
              value={frq1}
              onChange={(e) => update(e, setFrq1)}
            />
            <label htmlFor="frq2">
              How would you defend yourself during a zombie apocalypse with only
              items in your backpack that you brought to SB Hacks? (1200
              characters max)
            </label>
            <textarea
              id="frq2"
            ...
            <input
              ...
              id="agreeMLH"
              value={agrMLH}
              onChange={(e) => update(e, setAgrMLH)}
            />
            <label htmlFor="agreeMLH">
            ...
            <input
              ...
              id="agrEmail"
              value={agrEmail}
              onChange={(e) => update(e, setAgrEmail)}
            />
            <label htmlFor="agrEMail">
              I authorize MLH to send me pre- and post-event informaitonal
              emails, which contian free credit and opportunites from their
              partners.
            </label>
            <input
              type="checkbox"
              id="shareInfo"
              value={shareInfo}
              onChange={(e) => update(e, setShareInfo)}
            />
